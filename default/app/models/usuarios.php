...
//    public $debug = true;
    ...
    protected function initialize()
    {
        ...
        $this->has_many('auditorias','areas','roles_usuarios','configuraciones','responsables','vobopublicacion','estado','contenidomenu','contenidos','archivos','carpetas');
    ...
    public function getNombres($usuario_id) {
        $select = "u.nombres,u.id";
        $from = "usuarios as u";
        $joins = "LEFT JOIN areas as a on u.id = a.usuarios_id ";
        //$joins .= "LEFT JOIN noticiasyeventos as ne on a.id = ne.areas_id ";
        //$condiciones = "GROUP BY u.nombres'";
